...
use Jiro\Core\Extension\Container as ExtensionContainer;
use Jiro\Core\Extension\Extension;

/**
 * Core Package, ties in all the other packages to create Jiro "the platform"
 *
...
class Core 
{
	 ...
	 * Extension Container
	 *
	 * @var \Jiro\Core\Extension\Container
	 */
	...
	/**
	 * Boots core and its requirements.
	 *
	 * @return void
	 */
